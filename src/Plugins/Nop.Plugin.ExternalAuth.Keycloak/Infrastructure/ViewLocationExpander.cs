...
namespace Nop.Plugin.ExternalAuth.Keycloak.Infrastructure
{
    public class ViewLocationExpander : IViewLocationExpander
    {
        ...
        public IEnumerable<string> ExpandViewLocations(ViewLocationExpanderContext context, IEnumerable<string> viewLocations)
        {
            ...
            {
                viewLocations = new[] { $"/Plugins/Nop.Plugin.ExternalAuth.Keycloak/Areas/Admin/Views/{context.ControllerName}/{context.ViewName}.cshtml" }.Concat(viewLocations);
            }
            else
            {
                viewLocations = new[] { $"/Plugins/Nop.Plugin.ExternalAuth.Keycloak/Views/{context.ControllerName}/{context.ViewName}.cshtml" }.Concat(viewLocations);
            }
